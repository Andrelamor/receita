...
- [Issues](https://github.com/dados-mg/receita/issues): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/dados-mg/receita/pulls): Para sugerir uma alteração concreta na documentação.
